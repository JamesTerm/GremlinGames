Ramora = {
	...
	OSGV = "Ships/Vessels/Ramora/Ramora-01.osgv",
	...
	Mass = 1647500, -- Weight Kg
	RESPAWN_HITPOINTS = 1400500,	-- Hitpoints when respawning, 1 hit is about 1 cannon round
	...
	dHeading = 40, dPitch = 100, dRoll = 50,
	...
	Dimensions = 
	{ Length=320, Width=310, Height=70}, --These should be "roughly" correct in meters
