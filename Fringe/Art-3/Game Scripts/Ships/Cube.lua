Cube = {
	...
	MaxAccelLeft = 10, MaxAccelRight = 10, MaxAccelUp = 20, MaxAccelDown = 10, MaxAccelForward = 30, MaxAccelReverse = 10, 
	...
	Dimensions =
	{ Length=20, Width=20, Height=20}, --These should be "roughly" correct in meters

	Cannons = {
		-- There WILL be 2 cannons, but lets get this one working
		{
