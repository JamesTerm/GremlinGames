...
<body>
	<div id="wrapper">
		...
		<?php
			$images = array();
			$file;
			if ($handle = opendir($_SERVER["DOCUMENT_ROOT"].'/images/gallery/screens/thumbs/')) 
			{
			...
			{
				echo"<img src='/images/gallery/screens/thumbs/".$images[$i]."' onclick=\"load('screens', '".$images[$i]."')\"/>\n";
			}
			?>
