...
<body>
	<div id="wrapper">
		...
		<?php
			$images = array();
			$file;
			if ($handle = opendir($_SERVER["DOCUMENT_ROOT"].'/images/gallery/concepts/thumbs/')) 
			{
			...
			{
				echo"<img src='/images/gallery/concepts/thumbs/".$images[$i]."' onclick=\"load('concepts', '".$images[$i]."')\"/>\n";
			}
			?>
