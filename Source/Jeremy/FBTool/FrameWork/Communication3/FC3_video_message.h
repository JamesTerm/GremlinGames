...
{			// The frame format to use
			...
			// Constructor
			message( const e_data_type format, const int xres, const int yres, const int extra_data_size = 0 );
			...
			const e_data_type&	data_format( void ) const;
			...
			const __int64 duration( void ) const;
...
private:	// This is the data header
			...
			static const int message_size( const e_data_type format, const int xres, const int yres, const int extra_size );

			// Setup all pointers
			void setup_memory( const e_data_type format, const int xres, const int yres, const int extra_size );
