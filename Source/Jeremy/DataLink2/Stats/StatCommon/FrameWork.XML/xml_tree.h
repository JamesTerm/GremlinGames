...
{			
			...
			// Overloaded
				...
				//static void* operator new [] ( const size_t size );		// These are deliberately not implemented to ensure we cannot compile in a state that might nor work.
				//static void operator delete [] ( void* ptr );
...
private:	// The current implementation is based on xml::node. 
			...
			static void ss_init( simple_string& str );
			static void ss_free( simple_string& str );
			static void ss_set ( simple_string& str, const wchar_t text[] );
			static void ss_add ( simple_string& str, const wchar_t text[] );
			static void ss_set ( simple_string& str, const wchar_t text[], const int no_chars );						
			static void ss_add ( simple_string& str, const wchar_t text[], const int no_chars, const bool terminate = false );
