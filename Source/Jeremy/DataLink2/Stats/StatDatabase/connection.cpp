...
//			database::TESTHR(m_connection->Open("DRIVER={MySQL ODBC 5.1 Driver}; SERVER=localhost; DATABASE=test; USERID=testuser; PASSWORD=pass; OPTION=3", "testuser", "pass", ADODB::adConnectUnspecified));
		}
		catch (_com_error e)
		{
			close();
