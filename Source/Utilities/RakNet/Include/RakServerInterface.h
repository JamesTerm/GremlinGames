...
public:
	...
	/// \param[in] threadSleepTimer How many ms to ThreadSleep each internal update cycle (30 to give the game priority, 0 for regular (recommended), -1 to not ThreadSleep() (may be slower))
