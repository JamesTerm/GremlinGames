...
CommandLine="&quot;C:\Program Files (x86)\cmake-2.4.8-win32-x86\bin\cmake.exe&quot; -DBUILD_TYPE=$(OutDir) -P cmake_install.cmake"/>
	...
	<Files>
			<File
				RelativePath="$(GG_UTILITIES)\OSG_SVN\OpenSceneGraph\src\CMakeLists.txt">
				<FileConfiguration
					Name="Debug|Win32">
					<Tool
					Name="VCCustomBuildTool"
					Description="Building Custom Rule $(GG_UTILITIES)/OSG_SVN/OpenSceneGraph/src/CMakeLists.txt"
					...
					AdditionalDependencies="$(GG_UTILITIES)\OSG_SVN\OpenSceneGraph\src\CMakeLists.txt;&quot;C:\Program Files (x86)\cmake-2.4.8-win32-x86\share\cmake-2.4\Templates\CMakeWindowsSystemConfig.cmake&quot;;$(GG_UTILITIES)\OSG_SVN\OpenSceneGraph\src\CMakeLists.txt;"
		...
		<Filter
			...
			Filter="">
			<File
				RelativePath="$(GG_UTILITIES)\OSG_SVN\OSG_10297_VS_2008\src\CMakeFiles\INSTALL_force.rule">
				<FileConfiguration
					Name="Debug|Win32">
					<Tool
					Name="VCCustomBuildTool"
					Description=" "
					CommandLine=";"
					AdditionalDependencies="$(GG_UTILITIES)\OSG_SVN\OSG_10297_VS_2008\src\CMakeFiles\INSTALL_force.rule"
					Outputs="$(GG_UTILITIES)\OSG_SVN\OSG_10297_VS_2008\src\CMakeFiles\INSTALL_force"/>
				</FileConfiguration>
				<FileConfiguration
					Name="Release|Win32">
					<Tool
