...
!MESSAGE "osgPlugin ac3d - Win32 Release Static" (based on "Win32 (x86) Static Library")
!MESSAGE "osgPlugin ac3d - Win32 Debug Static" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /pdbtype:sept
# ADD LINK32 OpenThreadsWin32d.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"LIBC" /out:"$(OutDir)/osgdb_acd.dll" /pdbtype:sept /implib:"../../../lib/$(PlatformName)/osgdb_acd.lib" /libpath:"../../../lib/$(PlatformName)" /libpath:"../../../../OpenThreads/lib/$(PlatformName)" /libpath:"../../../../Producer/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib/$(PlatformName)" /libpath:"../../../../3rdParty/lib"
# SUBTRACT LINK32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin ac3d - Win32 Release Static"
...
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_ac_s.lib"
# SUBTRACT LIB32 /nodefaultlib

!ELSEIF  "$(CFG)" == "osgPlugin ac3d - Win32 Debug Static"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nodefaultlib /nologo /out:"$(OutDir)/osgdb_acd_s.lib"
# SUBTRACT LIB32 /nodefaultlib
...
# Name "osgPlugin ac3d - Win32 Release Static"
# Name "osgPlugin ac3d - Win32 Debug Static"
