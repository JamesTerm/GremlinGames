...
namespace lwosg
{
    ...
    public:
        ...
        Surface();
        Surface(const lwo2::FORM::SURF *surf, Clip_map &clips);

        void compile(const lwo2::FORM::SURF *surf, Clip_map &clips);

        osg::Group *apply(osg::Geometry *geo, const VertexMap_map *texture_maps, const VertexMap_map *rgb_maps, const VertexMap_map *rgba_maps, int max_tex_units, bool use_osgfx, bool force_arb_compression, const VertexMap_binding_map &texmap_bindings) const;

        void generate_stateset(int max_tex_units, bool force_arb_compression) const;
		...
		static osg::ref_ptr<const osgDB::ReaderWriter::Options> db_options_;
/*
...
*/
    private:
        ...
        Block_map blocks_;
		Block::Opacity_type hasTransMap_;
