// Producer_Trackball.h (copied from Producer\Trackball
#pragma once
...
namespace GG_Framework
{
	namespace UI
	{
		namespace OSG
		{
			...
			class FRAMEWORK_UI_OSG_API Producer_Trackball : public osg::Referenced 
			{
				public :
					//-------------------------------------------------------------------------
					// Constructor
						Producer_Trackball( void );
					...
					//     osg::Matrix  - matrix used to set or returned from a get.
					void setTranslation( const osg::Matrix tmat ) { T = tmat; }
					const osg::Matrix & getTranslation() const { return T; }

					void setRotation( const osg::Matrix rmat ) { R = rmat; }
					const osg::Matrix & getRotation() const { return R; }

					void setScaleMatrix( const osg::Matrix smat ) { S = smat; }
					const osg::Matrix & getScaleMatrix(void) const { return S; }
					...
					//-------------------------------------------------------------------------
					//  input()     - Updates the Producer_Trackball with new input, and/or for continuous
					//                matrix updates.
					...
					//-------------------------------------------------------------------------
					// getMatrix() - Returns the transform matrix as an osg::Matrix.  Note that
					//               this matrix is not valid until update() has been called.
					osg::Matrix &getMatrix( void );

					const osg::Matrix &getMatrix( void ) const;
				...
				protected :
					...
					osg::Matrix S;         // Scale matrix
					osg::Matrix O;         // Orientation osg::Matrix
					osg::Matrix R;         // Rotation osg::Matrix 
					osg::Matrix Rr;        // Reference Rotation osg::Matrix 
					osg::Matrix T;         // Translation osg::Matrix
					osg::Matrix Tr;        // Reference Translation :osg::Matrix
					osg::Matrix TX;        // Transform matrix
