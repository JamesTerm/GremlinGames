// GG_Framework.Base EventMap.cpp
#include "stdafx.h"
...
GG_Framework::Base::FrameLogger::FrameLogger(string logFileName) : m_logFileName(logFileName), m_active(false), m_currRecordedTimeSet(NULL)
{
}
//////////////////////////////////////////////////////////////////////////

void GG_Framework::Base::FrameLogger::ListenForToggleEvent(Event0& ev)
{
	ev.Subscribe(ehl, *this, &GG_Framework::Base::FrameLogger::ToggleActive);
}
//////////////////////////////////////////////////////////////////////////

void GG_Framework::Base::FrameLogger::ListenForTimerUpdate(Event1<double>& timerEv)
{
	timerEv.Subscribe(ehl, *this, &GG_Framework::Base::FrameLogger::TimeChanged);
}
//////////////////////////////////////////////////////////////////////////

GG_Framework::Base::FrameLogger::~FrameLogger()
{
	// Does nothing if already written
	WriteLog();
}

void GG_Framework::Base::FrameLogger::WriteLog()
{
...
void GG_Framework::Base::FrameLogger::TimeChanged(double t)
{
...
void GG_Framework::Base::ValueLogger::SetLogger(FrameLogger& fl)
{
	fl.TimerEvent.Subscribe(ehl, *this, &GG_Framework::Base::ValueLogger::TimerEvent);
	fl.WriteTitles.Subscribe(ehl, *this, &GG_Framework::Base::ValueLogger::WriteTitles);
	fl.WriteValues.Subscribe(ehl, *this, &GG_Framework::Base::ValueLogger::WriteValues);
}
//////////////////////////////////////////////////////////////////////////

void GG_Framework::Base::ValueLogger::WriteTitles(FILE* logFile)
{
	// Write our name to the log file
	fprintf(logFile,",%s", m_itemName.c_str());
}

void GG_Framework::Base::ValueLogger::TimerEvent(double lastTime, double currTime)
{
	// Remember our current value
	m_valSet.push_back(V);
}
void GG_Framework::Base::ValueLogger::WriteValues(FILE* logFile, double lastTime, double currTime)
{
...
GG_Framework::Base::ProfilingLogger::ProfilingLogger(string itemName) : 
...
void GG_Framework::Base::ProfilingLogger::Start()
{
	QueryPerformanceCounter((LARGE_INTEGER *)&begC);
}
void GG_Framework::Base::ProfilingLogger::End()
{
...
GG_Framework::Base::Timer::Timer(string logFileName) : _currentTime_s(0.0), Logger(logFileName)
{
...
double GG_Framework::Base::Timer::SetCurrTime_s(double t)
{
...
double GG_Framework::Base::Timer::IncTime_s(double i_s)
{
	if (i_s)
	{
		_currentTime_s += i_s;
