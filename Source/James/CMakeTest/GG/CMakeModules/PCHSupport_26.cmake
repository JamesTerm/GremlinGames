...
# See www.cmake.org/Bug/view.php?id=1260  bug 1260
...
# here we instruct CMake to build "ProjectName" executable from all the source files
...
MACRO(ADD_NATIVE_PRECOMPILED_HEADER _targetName _input)
	...
	if(CMAKE_GENERATOR MATCHES Visual*)
		...
		#James was here... this hack will be fine for visual studio to use stdafx.cpp for our purposes, we may wish to consider
		#to conform to the solution presented here (where we include ProjectName_pch as the source file to use) for when we wish
		#to work with other platforms
		SET_SOURCE_FILES_PROPERTIES( stdafx.cpp PROPERTIES COMPILE_FLAGS "${oldProps} /Yc\"${_input}\"")
