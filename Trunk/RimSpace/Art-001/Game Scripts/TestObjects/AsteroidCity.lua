AsteroidCity = {
	...
	OSGV = "TestObjects\\AsteroidCity.osgv",
	...
	ACCEL = .2,    -- Thruster Acceleration m/s2 (1g = 9.8)
	BRAKE = .2,     -- Brake Deceleration m/s2 (1g = 9.8)
	-- Turn Rates (deg/sec)	
	dHeading = 2, dPitch = 1, dRoll = 3,
	...
	Dimensions = 
	{ Length=1200, Width=1200, Height=1400}, --These should be "roughly" correct in meters
