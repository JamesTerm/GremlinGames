    ...
    */
    ...
    class System
    {
      ...
      public:
        ...
        FMOD_RESULT F_API create3DReverb         (Reverb **reverb, bool physical=false); 
        ...
        FMOD_RESULT F_API set3DReverbAmbientProperties(FMOD_REVERB_PROPERTIES *prop);
        FMOD_RESULT F_API get3DReverbAmbientProperties(FMOD_REVERB_PROPERTIES *prop);
    ...
    */
    class Reverb
    {
      ...
      public:    
        ...
        FMOD_RESULT F_API setPosition            (FMOD_VECTOR position);
        FMOD_RESULT F_API getPosition            (FMOD_VECTOR *position);
        FMOD_RESULT F_API setMinRadius           (float radius);
        FMOD_RESULT F_API getMinRadius           (float *radius);
        FMOD_RESULT F_API setMaxRadius           (float radius);
        FMOD_RESULT F_API getMaxRadius           (float *radius);
