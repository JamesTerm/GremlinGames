...
#define FMOD_VERSION    0x00040710
...
typedef enum
{
    FMOD_LISTENERREVERB_STATIC,                        /* The listener reverb setting stays where it's put */
    FMOD_LISTENERREVERB_DYNAMIC3D                      /* Listener reverb setting changes according to listener's 3D settings */
} FMOD_LISTENERREVERB_MODE;

/*
[ENUM]
[
    [DESCRIPTION]   
    reverb 3d locale modes
...
FMOD_RESULT F_API FMOD_System_Create3DReverb         (FMOD_SYSTEM *system, FMOD_REVERB **reverb, FMOD_BOOL physical);
...
FMOD_RESULT F_API FMOD_System_Set3DReverbAmbientProperties(FMOD_SYSTEM *system, FMOD_REVERB_PROPERTIES *prop);
FMOD_RESULT F_API FMOD_System_Get3DReverbAmbientProperties(FMOD_SYSTEM *system, FMOD_REVERB_PROPERTIES *prop);
...
FMOD_RESULT F_API FMOD_Reverb_SetPosition            (FMOD_REVERB *reverb, FMOD_VECTOR position);
FMOD_RESULT F_API FMOD_Reverb_GetPosition            (FMOD_REVERB *reverb, FMOD_VECTOR *position);
FMOD_RESULT F_API FMOD_Reverb_SetMinRadius           (FMOD_REVERB *reverb, float radius);
FMOD_RESULT F_API FMOD_Reverb_GetMinRadius           (FMOD_REVERB *reverb, float *radius);
FMOD_RESULT F_API FMOD_Reverb_SetMaxRadius           (FMOD_REVERB *reverb, float radius);
FMOD_RESULT F_API FMOD_Reverb_GetMaxRadius           (FMOD_REVERB *reverb, float *radius);
