...
namespace lwosg
{
	...
	struct Image_map {
		...
		Axis_type axis;
		int image_map;
		Clip *clip;		// is filled by Surface::compile()
		...
		static int GetNextTempClipIndex(){return --s_tempClipIndices;}
	...
	public:
		...
		inline void ChangeToColorBlock(){channel_ = "COLR";}
