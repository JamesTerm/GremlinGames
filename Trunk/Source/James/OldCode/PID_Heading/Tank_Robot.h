...
class Tank_Robot : public Tank_Drive
{
	...
	private:
		...
		PIDController2 m_PIDController_Left,m_PIDController_Right,m_PIDController_Heading;
		#ifdef __UseScalerPID__
		double m_CalibratedScaler_Left,m_CalibratedScaler_Right; //used for calibration
		#else
		double m_ErrorOffset_Left,m_ErrorOffset_Right,m_ErrorOffset_Heading; //used for calibration
		#endif
		...
		#endif
		LatencyPredictionFilter m_PID_Input_Latency_Heading;
};
