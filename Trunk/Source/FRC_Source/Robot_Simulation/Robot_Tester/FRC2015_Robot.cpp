...
FRC_2015_Robot_Control::FRC_2015_Robot_Control() : m_pTankRobotControl(&m_TankRobotControl),m_WinchVoltage(0.0),m_IntakeArmVoltage(0.0)
{
...
double FRC_2015_Robot_Control::GetRotaryCurrentPorV(size_t index)
{
	...
	//		break;
	//	case FRC_2015_Robot::eIntake_Arm:
