...
class FRC_2014_Robot : public Tank_Robot
{
	...
	protected:
		...
		{
			public:
				PowerWheels(FRC_2014_Robot *pParent,Rotary_Control_Interface *robot_control);
				IEvent::HandlerList ehl;
				virtual void BindAdditionalEventControls(bool Bind);
				virtual void ResetPos();
			protected:
		...
		class BallConveyorSystem
		{
			...
			public:
				BallConveyorSystem(FRC_2014_Robot *pParent,Rotary_Control_Interface *robot_control);
		...
		class Flippers : public Rotary_Position_Control
		{
			...
			public:
				Flippers(FRC_2014_Robot *pParent,Rotary_Control_Interface *robot_control);
				IEvent::HandlerList ehl;
				virtual void BindAdditionalEventControls(bool Bind);
			protected:
...
class FRC_2014_Turret_UI
{
	public:
		...
		FRC_2014_Turret_UI(FRC_2014_Robot_Control *robot_control) : m_RobotControl(robot_control) {}
	...
	private:
		FRC_2014_Robot_Control * const m_RobotControl;
		Actor_Text *m_UIParent;
		Turret_Properties m_props;
		osg::ref_ptr<osgText::Text> m_Turret; 
};

class FRC_2014_Power_Wheel_UI : public Side_Wheel_UI
{
	public:
		FRC_2014_Power_Wheel_UI(FRC_2014_Robot_Control *robot_control) : m_RobotControl(robot_control) {}
...
class FRC_2014_Lower_Conveyor_UI : public Side_Wheel_UI
{
	public:
		FRC_2014_Lower_Conveyor_UI(FRC_2014_Robot_Control *robot_control) : m_RobotControl(robot_control) {}
		//Client code can manage the properties
		virtual void Initialize(Entity2D::EventMap& em, const Wheel_Properties *props=NULL);
		virtual void TimeChange(double dTime_s);
	private:
...
class FRC_2014_Middle_Conveyor_UI : public Side_Wheel_UI
{
	public:
		FRC_2014_Middle_Conveyor_UI(FRC_2014_Robot_Control *robot_control) : m_RobotControl(robot_control) {}
		//Client code can manage the properties
		virtual void Initialize(Entity2D::EventMap& em, const Wheel_Properties *props=NULL);
		virtual void TimeChange(double dTime_s);
	private:
...
class FRC_2014_Fire_Conveyor_UI : public Side_Wheel_UI
{
	public:
		FRC_2014_Fire_Conveyor_UI(FRC_2014_Robot_Control *robot_control) : m_RobotControl(robot_control) {}
		//Client code can manage the properties
		virtual void Initialize(Entity2D::EventMap& em, const Wheel_Properties *props=NULL);
		virtual void TimeChange(double dTime_s);
	private:
...
class FRC_2014_Robot_UI : public FRC_2014_Robot, public FRC_2014_Robot_Control
{
	...
	private:
		...
		FRC_2014_Turret_UI m_TurretUI;
		FRC_2014_Power_Wheel_UI m_PowerWheelUI;
		FRC_2014_Lower_Conveyor_UI m_LowerConveyor;
		FRC_2014_Middle_Conveyor_UI m_MiddleConveyor;
		FRC_2014_Fire_Conveyor_UI m_FireConveyor;
};
