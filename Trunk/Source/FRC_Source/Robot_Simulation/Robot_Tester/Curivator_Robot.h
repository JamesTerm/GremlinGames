...
const char * const csz_Curivator_Robot_SolenoidDevices_Enum[] =
{
...
class Curivator_Robot : public Tank_Robot
{
	public:
		...
		{	return Enum_GetValue<SolenoidDevices> (value,csz_Curivator_Robot_SolenoidDevices_Enum,_countof(csz_Curivator_Robot_SolenoidDevices_Enum));
		}
	...
	protected:
		...
		class PitchRamp
		{
			private:
				...
				double m_Velocity; 
			public:
				PitchRamp(Curivator_Robot *pParent,Rotary_Control_Interface *robot_control);
				virtual ~PitchRamp() {}
				IEvent::HandlerList ehl;
				virtual void BindAdditionalEventControls(bool Bind);
				virtual void ResetPos();
	...
	public: //Autonomous public access (wind river has problems with friend technique)
		...
		{
			public:
				Kicker_Wheel(Curivator_Robot *parent,Rotary_Control_Interface *robot_control);
				IEvent::HandlerList ehl;
			protected:
