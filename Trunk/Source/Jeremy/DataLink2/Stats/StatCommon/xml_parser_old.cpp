...
{	// Create an expat parser
	...
	if ( xml_parser )
	{	// Setup the data
		XML_SetElementHandler( xml_parser, xml_creator::StartElementHandler, xml_creator::EndElementHandler );
		XML_SetCharacterDataHandler( xml_parser, xml_creator::CharacterDataHandler );
