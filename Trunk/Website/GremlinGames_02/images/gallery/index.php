...
<body>
	<div id="wrapper">
		...
		<div id="currentImage"><div id="loader" style="display: none;"></div></div>
		<div id="thumbs">
		<?php
			$images = array();
			$file;
			if ($handle = opendir($_SERVER["DOCUMENT_ROOT"].'/images/gallery/thumbs/')) 
			{
			...
			{
				echo"<img src='/images/gallery/thumbs/".$images[$i]."' onclick=\"load('".$images[$i]."')\"/>\n";
			}
			?>
